...
async function main() {
  ...
  // Debug: print raw fields from first entanglement record
  if (entangleRaw.length > 0) {
    console.log('DEBUG entangle record 0 keys:', Object.keys(entangleRaw[0]).join(', '));
    console.log('DEBUG Pre-Entanglement Sighting:', entangleRaw[0]['Pre-Entanglement Sighting']);
    console.log('DEBUG Pre-Entanglement Location:', entangleRaw[0]['Pre-Entanglement Location']);
    console.log('DEBUG Status/Details:', entangleRaw[0]['Status/Details']);
  }
  if (scarsRaw.length > 0) {
    console.log('DEBUG scars record 0 keys:', Object.keys(scarsRaw[0]).join(', '));
    console.log('DEBUG Status/Details:', scarsRaw[0]['Status/Details']);
  }
